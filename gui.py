...
b1 = Button(root, text="About PDF", command=about, width=50, height=2, borderwidth=3, bg="#51ECCA", font=("Consolas",15,"bold"))
b2 = Button(root, text="Merge PDFs", command=merge, width=50, height=2, borderwidth=3, bg="#51ECCA", font=("Consolas",15,"bold"))
b3 = Button(root, text="Split PDF", command=split, width=50, height=2, borderwidth=3, bg="#51ECCA", font=("Consolas",15,"bold"))
b4 = Button(root, text="Extract Single Page from PDF", command=extract, width=50, height=2, bg="#51ECCA", borderwidth=3, font=("Consolas",15,"bold"))
b5 = Button(root, text="Rotate PDF", command=rotate, width=50, height=2, borderwidth=3, bg="#51ECCA", font=("Consolas",15,"bold"))
b6 = Button(root, text="Encrypt PDF with password", command=encrypt, width=50, height=2, bg="#51ECCA", borderwidth=3, font=("Consolas",15,"bold"))
